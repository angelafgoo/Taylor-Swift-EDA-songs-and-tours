...
# TOUR REVENUES
# Configurar la localización para formato de dinero en dólares
...
with trev_col:
    with st.container():
        ...
        formatted_kpi4 = locale.currency(kpi4, grouping=True)
...
""")
    ...
    for index, row in filtered_df_us.iterrows():
        ...
        formatted_revenue = locale.currency(row['Revenue_y'], grouping=True)
        # Construir el contenido del popup con información adicional (en este caso, el Venue)
